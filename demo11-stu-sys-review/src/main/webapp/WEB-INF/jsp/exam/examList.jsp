		...
		<script type="text/javascript">
			$(function() {
				...
				$("#escore").click(function() {
					...
					let exam = $("#dataList").datagrid("getSelected");
					if(exam == null) {
				...
				$("#redo").click(function() {
					let exam = $("#dataList").datagrid("getSelected");
					let clazzid = exam.clazzid;
					if(exam.type == 1) {
						clazzid = $("#escoreClazzList").combobox("getValue");
					}
					//let data = {id: exam.id, gradeid: exam.gradeid, clazzid:clazzid,courseid:exam.courseid, type: exam.type};

					let url = "ScoreServlet?method=ExportScore&id=" + exam.id + "&gradeid=" + exam.gradeid + "&clazzid=" + clazzid + "&courseid=" + exam.courseid + "&type=" + exam.type;
