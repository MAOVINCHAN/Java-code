			...
			$(function() {
				...
				$("#passwordDialog").dialog({
					...
					buttons: [{
						...
						handler: function() {
							let validate = $("#editPassword").form("validate");
							if(!validate) {
				...
				$("#systemTable a").each(function() {
					$(this).click(function() {
						...
						if(inputName == "forbidTeacher" || inputName == "forbidStudent") {
							...
							let name = $(input).attr("textboxname");
							let value = $(input).textbox("getValue");
						}
			...
			<div style="width: 650px">
				<table id="systemTable" class="table table-border table-bordered table-striped" style="width: 650px" cellpadding="8">
					<tr>
						...
						<td width="100">
							<a data-options="iconCls:'icon-save'" class="easyui-linkbutton">保存</a>
						</td>
					</tr>
					<tr>
						<td>禁止教师<br/>登录系统 </td>
