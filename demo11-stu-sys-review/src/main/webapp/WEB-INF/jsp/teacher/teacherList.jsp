 		        	...
 		        	formatter: function(value,row,index){
 						if (row.courseList){
 							...
 							for(let i = 0;i < courseList.length;i++){
 								let gradeName = courseList[i].grade.name;
 								let clazzName = courseList[i].clazz.name;
 								let courseName = courseList[i].course.name;
				...
				},
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							let sex = $("#add_sex").textbox("getText");
							let phone = $("#add_phone").textbox("getText");
							let qq = $("#add_qq").textbox("getText");
							let data = {number:number, name:name,sex:sex,phone:phone,qq:qq,course:chooseCourse};
	  ...
	  //下拉框通用属性
	  	...
	  	$("#editDialog").dialog({
				...
				},
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							let sex = $("#edit_sex").textbox("getText");
							let phone = $("#edit_phone").textbox("getText");
							let qq = $("#edit_qq").textbox("getText");
							let data = {id:id, number:number, name:name,sex:sex,phone:phone,qq:qq,course:chooseCourse};
			...
			onBeforeOpen: function(){
				...
				for(let i = 0;i < courseList.length;i++){
					let gradeId = courseList[i].grade.id;
					let gradeName = courseList[i].grade.name;
					let clazzId = courseList[i].clazz.id;
					let clazzName = courseList[i].clazz.name;
					let courseId = courseList[i].course.id;
					let courseName = courseList[i].course.name;
					//添加到表格显示
					let tr = $("<tr class='chooseTr'><td>课程:</td></tr>");
