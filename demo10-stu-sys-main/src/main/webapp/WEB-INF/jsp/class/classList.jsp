...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({
	        ...
	        fit: true,//自动大小 
	        method: "get",
	        url:"/class?action=data&t="+new Date().getTime(),
	        idField:'cid',
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'gradeName',title:'所属年级',width:100,
		...
		// 清空
		$("#clean").click(() => {
			let gradeListId = $('#gradeList').combobox("getValue");
			if(!gradeListId) return;
			$('#gradeList').combobox("setValue", null);
		})
	  	...
	  	$("#gradeList").combobox({
	  		...
	  		editable: false, //不可编辑
	  		method: "get",
	  		url: "/grade?action=data&t="+new Date().getTime(),
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin: 0 10px 0 10px">
			...
			<input id="clean" class="easyui-button" type="button" value="清空" />
		</div>
	</div>
