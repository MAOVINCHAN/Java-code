...
//     @Before("execution(* com.learn.demo.CalculatorImpl.*(..))")
//     public void my_before(JoinPoint jp) {
//         String name = jp.getSignature().getName();
//         System.out.println(name + "开始执行了");
//     }
//
//     @Around("execution(* com.learn.demo.CalculatorImpl.*(..))")
...
//     }
//
//     @After("execution(* com.learn.demo.CalculatorImpl.*(..))")
//     public void my_after(JoinPoint jp) {
//         String name = jp.getSignature().getName();
//         System.out.println(name + "执行结束了");
//     }
//
//     @AfterReturning(value = "execution(* com.learn.demo.CalculatorImpl.*(..))", returning = "res")
//     public void my_returning(JoinPoint jp, Object res) {
//         String name = jp.getSignature().getName();
//         System.out.println(name + "执行后的返回值为： " + res);
//     }
//
//     @AfterThrowing(value = "execution(* com.learn.demo.CalculatorImpl.*(..))", throwing = "err")
